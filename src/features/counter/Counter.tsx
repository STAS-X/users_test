	...
	return (
		<div>
			<div className='flex w-min px-4 py-2 rounded-lg shadow-md items-center justify-center gap-4 bg-gray-400 mx-auto mt-8'>
				...
				<span className='bg-gray-200 text-gray-600 px-8 py-2 text-3xl rounded-md shadow-inner'>{count}</span>
				<button
			...
			<div className='flex w-max px-4 py-2 rounded-lg shadow-md items-center justify-center gap-4 bg-gray-400 mx-auto mt-8'>
				<input
					...
					className='bg-gray-200 px-4 py-2 w-12 text-gray-600 rounded-sm text-center outline-none focus:outline-none focus:ring-8 ring-purple-600'
				/>
				<button
