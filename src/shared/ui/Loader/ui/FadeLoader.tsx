...
import { cssValue, parseLengthAndUnit } from '../../../lib/helpers/unitConverter';
import { LoaderHeightWidthRadiusProps } from '../../../lib/helpers/props';
import { createAnimation } from '../../../lib/helpers/animation';
...
export const FadeLoader = ({
	...
	const wrapper: React.CSSProperties = {
		...
		//top: radiusValue,
		//left: radiusValue,
		width: 'auto', //`${radiusValue * 3}px`,
		height: 'auto', //`${radiusValue * 3}px`,
		transform: `scale(0.4)`,
		...cssOverride
	};
